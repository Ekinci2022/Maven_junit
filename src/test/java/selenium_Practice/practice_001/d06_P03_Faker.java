...
public class d06_P03_Faker extends TestBase {
    ...
    public void name() {
        ...
        firstName.sendKeys(faker.name().firstName(), Keys.TAB, faker.name().lastName(),Keys.TAB,faker.internet().emailAddress(),Keys.TAB,Keys.SPACE,Keys.TAB,faker.phoneNumber().cellPhone(),Keys.TAB
                ,"20 Jul 1980",Keys.ENTER,Keys.TAB,faker.shakespeare().romeoAndJulietQuote(),Keys.TAB,Keys.SPACE,Keys.ARROW_DOWN,Keys.PAGE_DOWN,Keys.PAGE_DOWN);


        WebElement dosyaSec = driver.findElement(By.xpath("//*[@id='uploadPicture']"));
       String dosyaYolu = "C:/Users/abdul/OneDrive/Desktop/Yeni Metin Belgesi.txt";
