...
public class P02 {
    ...
    public static void main(String[] args) {
        ...
        firstName.sendKeys("Mete", Keys.TAB,"Han",Keys.TAB,Keys.ARROW_RIGHT,Keys.TAB,
                Keys.ARROW_RIGHT,Keys.ARROW_RIGHT,Keys.ARROW_RIGHT,Keys.TAB,"12/12/2022",Keys.TAB,Keys.TAB,Keys.SPACE,
                Keys.TAB,Keys.TAB,Keys.TAB,Keys.SPACE,Keys.TAB,"Africa",Keys.TAB,Keys.LEFT_CONTROL,Keys.SPACE,
